...
if choice1 == "left":
    print("You've come to a lake. There is "
            "an island in the middle od the lake.")
    choice2 = input(" Type Wait to wait for a boat. "
                    "OR Type Swim to swim across. \n").lower()
    if choice2 == "wait":
        door = input("You arrive at island unharmed. "
                     "There is a house with 3 doors. One red , "
                     "one yellow and one blue. which colour do "
                     "you choose?\n").lower()
        if door == "red":
            print("Burned by life.\n Game Over.")
        elif door == "blue":
